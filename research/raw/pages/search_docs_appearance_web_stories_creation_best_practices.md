...
## 
 ...
 Note: The same
 SEO
 best practices for web pages also apply to Web
 Stories. A Web Story is still a web page.
 ...
 AMP story
 metadata guidelines. Include markup that you would normally include on a web page, such as:
