...
# Understanding Core Web Vitals and Google search results
 ...
 Core Web Vitals is a set of metrics that measure real-world
...
- Interaction To Next Paint (INP):
 ...
 an INP of less than 200 milliseconds.
...
- Check the Core Web
 Vitals report in Search Console. This shows how your pages perform.
 
- Learn more about Core
 Web Vitals, a guide about Core Web Vitals, including
 how to measure, debug, improve and best practices.
 
- Learn about the different tools that can help you
 measure
 and report Core Web Vitals. These tools measure LCP, INP, and CLS. 
