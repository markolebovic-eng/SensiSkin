...
- Using structured data enables a feature to be present, it does not
 ...
 appropriate than another, or even that a text result is best.
...
- The page doesn't meet the guidelines for structured data described on this page, the
 guidelines for a specific structured data feature, the Search Essentials,
 or the Content policies for Google Search.
