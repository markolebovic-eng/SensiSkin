...
### How Google indexes and chooses the canonical URL
 ...
 together. Google then chooses the page that, based on the factors (or signals) the
 ...
 Read more about
 how to indicate your preference for the canonical URL, and whether you need to.
