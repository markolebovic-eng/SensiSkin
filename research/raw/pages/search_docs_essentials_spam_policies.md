...
- Inserting text or keywords into a page only when the user agent that is requesting the
 ...
 for the site owner to detect. Read more about fixing hacked sites
...
- Redirects: Hackers might inject malicious code to your website that redirects some
 ...
 Here are our tips on fixing hacked sites
 and avoiding being hacked.
...
- Advertorials or native advertising where payment is received for articles that include
 ...
 There are many wedding rings on the market.
 If you want to have a wedding, you will have to pick
 the best ring. You will also need to
 buy flowers and a wedding dress.
...
- Forum comments with optimized links in the post or signature, for example:
 Thanks, that's great info!- Paulpaul's pizza
...
- Copying content from other sites, modify it only slightly (for example, by
 substituting synonyms or using automated techniques),
 and republish it
