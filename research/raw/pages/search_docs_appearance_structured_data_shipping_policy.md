...
- 
 ...
 under the Organization structured data type. For more information, see Organization markup.
...
- 
 ...
 See merchant listing markup for the subset of properties that are supported for product-level shipping policies.
...
- https://schema.org/FulfillmentTypeCollectionPoint: The product is shipped to a collection point for customer pickup.
 ...
 See also the list of ServicePeriod
...
### ShippingConditions (nested under ShippingService
 ...
 See also the list of MonetaryAmount
 ...
 Indicates shipping destination, if applicable. See the list of DefinedRegion
 ...
 Indicates shipping origin, if applicable. See the list of DefinedRegion
 ...
 See also the list of OpeningHoursSpecification
 ...
 See also the list of ShippingRateSettings
 properties and MonetaryAmount
 properties supported for the ShippingConditions type by Google. This property
 ...
 See also the list of QuantitativeValue
 properties related to the ShippingConditions type supported by Google.
...
#### QuantitativeValue (in the context of shipping packing dimensions)
 ...
 QuantitativeValue for handling times and
 
 QuantitativeValue for transit times.
...
## 
 ...
 shipping policies in Search Console,
