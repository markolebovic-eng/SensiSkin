...
Deferring loading of non-critical or non-visible content, also commonly known as "lazy-loading", is a common performance and UX best practice. For more information, see web.dev's resources on lazy-loading images and video.
...
- Link sequentially to the individual URLs so that search engines can discover the URLs in a
 ...
 best
 practices when implementing pagination.
...
## Test
 ...
 You can use the URL Inspection Tool in Search Console to see if all content was loaded.
