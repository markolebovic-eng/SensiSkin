...
# Improving SEO with a Search Console bubble chart
 ...
 connect your data to Looker Studio and play with the chart settings.

 

 If you haven't read connecting Search Console to Looker Studio and
 monitoring Search traffic with Looker Studio,
...
### Data source
 ...
 which includes Search performance data
...
- Query: Include or exclude queries to focus on. You can filter your data
...
- Log scale: Using a logarithmic scale
...
- Your competitors may have structured data markup
 ...
 visual elements in Google Search.
...
## Improving SEO for specific queries 
 ...
 URLs, use the SEO starter guide
 to optimize your content. Here are some tips:

 
- Ensure that your title elements,
 description meta tags, and alt
...
- Think about other words that a user might search for to find a piece of your content, for
 ...
 use Google Trends to find ideas
