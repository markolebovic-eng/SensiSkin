...
- Read the documentation
 for the Crawl Stats report to learn how to find and handle some availability issues.
...
- Increase your server capacity. If Google consistently seems to be crawling
 ...
 Crawl Stats
 report to see if Google's crawl rate seems to be crossing the limit line often. If so,
...
If you are adding pages to your site and they are not being crawled in a reasonable amount of
 ...
 maximum serving capacity, or you are out of crawl budget.
...
- Review your crawling priorities (a.k.a. use your crawl budget wisely). Manage
 your inventory and improve your site's crawling efficiency.

- Check that you're not running out of serving capacity.
...
- Use a news sitemap if your site
 has news content.
...
- Provide standard, crawlable <a> links
...
- If your site uses separate HTML for mobile and desktop versions, provide the same set of links
 ...
 Google only
 indexes the
 mobile version of pages, and limiting the links shown there
...
### Specify content changes with HTTP status codes
 ...
 If-Modified-Since and If-None-Match HTTP request headers
...
- 
 ...
 manage crawling of faceted navigation pages.

- Duplicate content:
 Help Google identify duplicate content to avoid unnecessary crawling.

- soft 404 pages: Return a 404
 code when a page no longer exists.

- Hacked pages: Be sure to check
 the Security
 Issues report and fix or remove any hacked pages you find.
