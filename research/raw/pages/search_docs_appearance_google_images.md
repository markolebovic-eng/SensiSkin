...
<img src="data:image/svg+xml;base64,[data]">
 ...
 section on the advantage and disadvantages of inlining images on our web.dev page.
...
- Specify the schema.org primaryImageOfPage
...
<script type="application/ld+json">{
 ...
 or mainEntityOfPage properties):
...
### Use descriptive filenames, titles, and alt text
 ...
 URL encoding guidelines if you're using
...
- 
 ...
 cloaking and won't result in manual
 actions.

 Alternatively, you can
 prevent the image from appearing in search results entirely.
...
## Optimize for SafeSearch
 ...
 Learn more about labeling pages for SafeSearch.
