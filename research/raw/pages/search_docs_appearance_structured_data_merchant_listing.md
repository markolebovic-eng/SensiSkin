...
Here is an example of a product page with return details. The markup matches a return policy
 ...
 type, as documented under merchant return policies.
...
"image": [
 ...
 Product snippets accept an Offer
 or AggregateOffer
 but merchant listings require an Offer
 ...
 See the list of PeopleAudience properties
 supported by Google.
 ...
 
{
 ...
 European countries. See also the list of Certification properties
 supported by Google.
 ...
 instead, if possible, with the required Certification properties
...
"hasEnergyConsumptionDetails": {
 ...
 product variant structured data documentation.
 ...
 review properties.
 See also the list of additional Review properties
 ...
 Google Merchant Center Product Data Specification page.
 See the list of SizeSpecification properties
...
- The sku value must not contain any whitespace characters (as defined by
 the Unicode whitespace property).
...
- We recommend that the sku value only contain ASCII characters.
 ...
 A 3D model for the product, if applicable. See the list of 3DModel properties properties supported by Google. Specify at most one 3DModel value.
...
#### 3DModel
 ...
 The link to a 3D model definition file in glTF format. The file must have a .gltf or .glb suffix.
...
"offers": {
 ...
 UnitPriceSpecification
 properties and the pricing examples of how to mark up
...
- https://schema.org/SoldOut: The item has been sold out.
 ...
 MerchantReturnPolicy properties for individual offers.
...
- https://schema.org/UsedCondition: The item is used (it is not new).
 ...
 OfferShippingDetails properties.
...
#### UnitPriceSpecification
 ...
 See the fourth example in member price examples
 and the article Loyalty program in Google Merchant Center Help.

 Refer to
 loyalty program markup for
 ...
 you must also provide a current sale price with the price or
 priceSpecification property on
...
#### QuantitativeValue (for unit pricing)
 ...
 Pricing with unit pricing measures and the article
...
- https://schema.org/WearableSizeGroupMaternity: The item size is "maternity".
 ...
 Supported structured data types and values
...
#### PeopleAudience
 ...
 See also Supported structured data attributes and values
 in Google Merchant Center Help.
...
- Vehicle_CO2_Class_Discharged_Battery for the CO2 class of a vehicle with a discharged battery
 ...
 you don't have EPREL codes, you can use the certificationRating property
...
- transitTime
 ...
 See also the list of ShippingDeliveryTime properties
 supported by Google.
 ...
 See also the list of DefinedRegion properties
 supported by Google.
...
#### DefinedRegion
 ...
 The two-letter country code, in ISO 3166-1 alpha-2
 format.
...
#### MerchantReturnPolicy
 ...
 If you provide both organization-level
...
- https://schema.org/FreeReturn: There's no charge to the consumer to
 return the product. If used, don't include the returnShippingFeesAmount
 property.
...
- https://schema.org/ReturnShippingFees: There's a shipping fee
 ...
 returnShippingFeesAmount property.
...
return settings with Google
 ...
 shipping and return policies in Search Console,
...
- Settings in the Content API for Shopping
