...
## 
 ...
 The technical requirements cover the bare
...
The spam policies detail the behaviors
...
## 
 ...
 While there are many things you can do to improve your site's SEO,
...
- Use words that people would use to look for your content, and place those words in
 prominent locations on the page, such as the title and main heading
 of a page, and other descriptive locations such as alt text
 and link text.
...
- If you have content that shouldn't be found in search results or you want to opt out entirely,
 use the appropriate method for controlling how your content appears in Google Search.
