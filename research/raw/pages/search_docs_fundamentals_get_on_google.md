...
## 
 ...
 can find additional getting started information in the SEO Starter Guide.

### 
 Is your website showing up on Google?

 To see if your pages are already indexed,
...
site:example.com
 ...
 under the prefix specified in the query. Learn more about the site: operator.
...
- Your site isn't linked to by other sites on the web. See if you can get
 ...
 considered a violation of Google's spam policies).
 
- You've just launched a new site and Google hasn't had time to crawl it yet. It can take a
...
- Google received an error when trying to crawl your site. Most common reasons for this are
 ...
 Make sure that you can access your site in an incognito window.
...
- Google missed it: Although Google crawls billions of pages, it's inevitable
 ...
 If you're feeling adventurous, you can add your site to Search Console
 to see if there's an error that might prevent Google from
 understanding your site. You can also send us your most important URLs
...
### 
 ...
 creating content that's helpful, reliable, and people-first.
 To make sure that you're managing your website using Google-friendly
 practices, read the Search Essentials.
...
### 
 ...
 including Search and Maps. Consider claiming your Business Profile.
...
### 
 ...
 You can use tools such as Lighthouse to test if your page is mobile-friendly.
...
### 
 ...
 increase visibility on search engines. Learn more about why and how to hire an SEO.
