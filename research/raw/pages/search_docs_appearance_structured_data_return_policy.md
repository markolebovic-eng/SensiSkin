...
- 
 ...
 under the Organization structured data type. Refer also to the Organization markup for more information.
...
### MerchantReturnPolicy (nested under Organization
 ...
 Use the two-letter ISO 3166-1 alpha-2
...
- https://schema.org/ReturnInStore: The item can be returned in store.
 ...
 returnFees equals https://schema.org/ReturnShippingFees.
