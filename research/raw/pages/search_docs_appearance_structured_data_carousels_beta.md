...
- 
 ...
 Google Search aggregator features interest form
...
- 
 For shopping queries in CSS Program countries,
...
- Add the required properties to that summary
...
- The general properties that all carousels must have (image,
 url, name)
