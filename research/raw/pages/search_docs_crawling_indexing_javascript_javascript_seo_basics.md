...
# Understand the JavaScript SEO basics
 ...
 Learn how to fix JavaScript-related problems with our troubleshooting guide.
...
- Indexing
 ...
 When Googlebot fetches a URL from the crawling queue by making an HTTP request, it first checks if you allow crawling. Googlebot reads the robots.txt file.
...
## Write compatible code
 ...
 compatible with Google, follow our guidelines for troubleshooting JavaScript problems.
...
## Use the History API instead of fragments
 ...
 For single-page applications with client-side routing, use the History API to implement routing between different views of your web app.
...
## Follow best practices for web components
 ...
 When Google renders a page, it flattens the shadow DOM and light DOM content.
 This means Google can only see content that's visible in the rendered HTML. To make sure that Google can still see your content after it's rendered, use the Rich Results Test or the URL Inspection Tool and look at the rendered HTML.
...
## Fix images and lazy-loaded content
 ...
 To make sure you're implementing lazy-loading in a search-friendly way, follow our lazy-loading guidelines.
