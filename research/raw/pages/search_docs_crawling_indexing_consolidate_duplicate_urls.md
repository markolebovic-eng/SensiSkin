...
# How to specify a canonical URL with rel="canonical" and other methods
 ...
 To specify a canonical URL for
...
- 
 ...
 Google will identify which version of the URL is objectively the best version to show to users in Search.
...
- 
 ...
 Google generally doesn't support URL fragments.
 
 
- 
 Do include a rel="canonical" link on the canonical page
 itself (also known as a self-referential canonical).
...
<!-- rest of the HTML -->
 ...
 We recommend adding this same self-referential
 rel="canonical" link element to the canonical page itself as well.
...
### Prefer URLs in hreflang clusters
 ...
 Read more about
 troubleshooting and fixing canonicalization issues.
