...
# List of Google's common crawlers
 ...
 Caution: The HTTP user agent string can be spoofed.
...
disallow: /archive
 ...
 | Affected products
 | 
 Crawling preferences addressed to the Googlebot user agent affect Google
...
disallow: /archive/moons.jpg
 ...
 | Affected products
 | 
 Crawling preferences addressed to the Googlebot-Image user agent affect
...
disallow: /archive/
 ...
 | Affected products
 | 
 Crawling preferences addressed to the Googlebot-Video user agent affect
...
## Googlebot News
 ...
 | User-Agent in HTTP requests
 | 
 Googlebot-news doesn't have a separate HTTP request user agent string. Crawling is done
...
disallow: /archive/
 ...
 | Affected products
 | 
 Crawling preferences addressed to the Googlebot-News user agent affect
...
disallow: /archive/konbini
 ...
 | Affected products
 | 
 Crawling preferences addressed to the Storebot-Google user agent affect
...
disallow: /archive/
 ...
 | Affected products
 | 
 Crawling preferences addressed to the Google-InspectionTool user agent
...
disallow: /archive/
 ...
 | Affected products
 | 
 Crawling preferences addressed to the GoogleOther user agent don't affect
...
disallow: /archive/moon.jpg
 ...
 | Affected products
 | 
 Crawling preferences addressed to the GoogleOther-Image user agent don't
...
disallow: /archive
 ...
 | Affected products
 | 
 Crawling preferences addressed to the GoogleOther-Video user agent don't
...
disallow: /archive/
 ...
 | Affected products
 | 
 Crawling preferences addressed to the Google-CloudVertexBot user agent
...
## Google-Extended
 ...
 | User-Agent in HTTP requests
 | 
 Google-Extended doesn't have a separate HTTP request user agent string. Crawling is
