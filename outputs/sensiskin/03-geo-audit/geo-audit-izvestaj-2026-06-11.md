...
**Metod:** Verifikacija UŽIVO — direktan crawl renderovanog DOM-a (Chrome) za 10 ključnih strana + robots.txt. Sve ocene su zasnovane na onome što je stvarno objavljeno, ne na pretpostavci.

---

## SEKCIJA 1 — Izvršni sažetak

### Novi GEO skor: **62 / 100**  ⬆️ (sa 21/100 — napredak +41)
...
| 3 | **Schema markup** | kritično | **8/10** | Veliki napredak: FAQPage, Service, Person, Article, MedicalOrganization, WebSite. Minus: nema Breadcrumb, AggregateRating, HowTo. |
...
| 5 | **Topikalni autoritet** | ~5% | **4/10** | Service teme pokrivene; blog klaster i dalje tanak (novi post 404, malo blogova). |
...
Za mesec dana ste otišli sa **21 → 62**. To je ozbiljan, merljiv napredak i najteži deo (schema + sadržaj + E-E-A-T temelji) je urađen kvalitetno — strana „Sve istine o laserskoj epilaciji" je primer kako sve treba da izgleda. Da bi prešli 75+, fokus je: (1) objaviti blog koji je 404, (2) FAQ schema na preostale strane, (3) recenzije/AggregateRating, (4) potvrditi off-site NAP + GBP. Stvarne AI citacije će se pojaviti tek kad AI motori ponovo iscrawluju sajt — to merimo za 3–6 nedelja.
